/* const slideElement = `<div class="page-container">
                    ...
                    <div class="slides">
                        <div class="slideshow-left">
                            <div class="slide-header">
                                <h2>"Jod is phenomenal. An absolute pleasure to work with!"</h2>
                                <p class="client-name">NotJod</p>
                                <p class="client-company">company name</p>
                        ...
                        <img src="./assets/img/temp_jod.jpg" alt="client image" class="slide-img">
                    </div>
                    <div class="slides">
                        <div class="slideshow-left">
                            <div class="slide-header">
                                <h2>"Beyond standards. Jod grasped our vision and brought it to life brilliantly."</h2>
                                <p class="client-name">DefinitelyNotJod</p>
                                <p class="client-company">company name</p>
                                <div class="project-tag">
                                    <span>web dev</span>
                                    <span>web design</span>
...
const testimonial = (clientName, clientCompany, statement, projectTag) => {
	return { clientName, clientCompany, statement, projectTag };
};
...
export default function renderSlideShow() {
	...
	// Append the container to the body (or wherever you want to place it)
